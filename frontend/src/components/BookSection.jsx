    ...
    return (
        <div className="flex flex-wrap justify-center items-center text-white gap-4 p-4">
            {data && data.map((item, index) => (
                ...
                >
                    <a href="#">
                        <img style={{height:"300px", width: "200px"}} className=" mx-auto p-8 rounded-t-lg items-center" src={item.imageUrl} alt="failure" />
                    </a>
                    <div className="px-5 pb-5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <a href="#" className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800">DELETE</a>
                        </div>
                    </div>
                </div>
            ))}
